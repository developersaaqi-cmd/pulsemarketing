  ...
  return (
    <html lang="en" className="scroll-smooth" style={{ overflowX: "hidden" }}>
      <head>
        ...
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="600" />{" "}
        <meta property="og:description" content="Our Objective: Increase Your Revenue. Boost your brand with our expert websites, apps, and branding solutions. Bring your vision to life with Pulse." />
