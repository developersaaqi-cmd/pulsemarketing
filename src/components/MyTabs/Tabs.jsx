...
export default function Tabs() {
  ...
  return (
    <main
      className="m-auto w-full lg:w-full ct-portfolio-wrapper"
      style={{
        backgroundImage: "url('/images/app_page_images/radial.png')",
        backgroundSize: "contain",
        backgroundRepeat: "no-repeat",
      ...
      <div className="ct-container">
        ...
        <div className="mx-auto flex flex-wrap justify-start gap-8 lg:w-[100%]">
          {tabs.map((tab, index) => (
            <div
              key={index}
              className={`flex w-[45%] cursor-pointer flex-wrap items-center justify-start rounded text-center text-[1.2rem] font-medium md:w-auto md:text-[1.6rem] ${
