  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full flex-col items-center justify-center ct-container" id="service-page-banner">
        <div className="z-10 flex flex-col">
          ...
          <div className="-ml-[4px] mb-2 flex items-center gap-1 md:-ml-[5px]">
            <Image
              ...
              loading="eager"
            />
            <p className="text-white">CRO Services</p>
          </div>
          ...
          >
             Turn Traffic <br /> Into Revenue
          </h2>

          <div className="my-4 w-[90%] border-l-2 pl-3">
            <h2 className="poppins-light">
               Optimize your site to convert more <br/>visitors without increasing ad spend.
            </h2>
          </div>
        ...
        <div className="cro-banner-img">
          <img src="/images/cro_page_images/cro-page-upper-min 1.svg" />
        </div>
      </div>
    </main>
  );
