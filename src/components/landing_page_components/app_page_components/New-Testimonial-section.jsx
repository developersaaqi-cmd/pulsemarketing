...
const testimonials = [
  {
    title: 'Aspiring DJ Brand Identity & Logo Creation',
    text:
  ...
  {
    title: 'Complete Business Website Revamp & Branding',
    text:
  ...
  {
    title: 'Fitness Brand Website Design & Launch Project',
    text:
  ...
  {
    title: 'Luxury Cottage Rental Website Design Project',
    text:
  ...
  {
    title: 'Creative Design Agency Frontend Website Revamp',
    text:
  ...
  {
    title: 'Small Business Website Design & Launch Project',
    text:
  ...
  {
    title: 'Professional Trading Company Website Overhaul',
    text:
  ...
  {
    title: 'Custom CRM & Business Software Solutions',
    text:
  ...
  {
    title: 'E-Commerce Store Design & Performance Upgrade',
    text:
  ...
  {
    title: 'Startup Brand Identity & Website Development',
    text:
  ...
  {
    title: 'Real Estate Website Design & Lead Capture',
    text:
  ...
  {
    title: 'Personal Brand Website Design for Coach',
    text:
  ...
  {
    title: 'Medical Clinic Website Redesign & UX Focus',
    text:
  ...
  {
    title: 'Professional Law Firm Website & Branding',
    text:
  ...
  {
    title: 'Mobile App Launch Landing Page Design',
    text:
  ...
  {
    title: 'Construction Company Website Design Project',
    text:
  ...
  {
    title: 'Non-Profit Organization Website Development',
    text:
  ...
  {
    title: 'Complete Digital Marketing Funnel Setup',
    text:
  ...
  {
    title: 'Corporate Website Design & CMS Integration',
    text:
  ...
  {
    title: 'Fashion Brand Online Store & Visual Identity',
    text:
  ...
  {
    title: 'Automotive Business Website Design Upgrade',
    text:
  ...
  {
    title: 'SaaS Product Website & User Interface Design',
    text:
  ...
  {
    title: 'Professional Photography Portfolio Website',
    text:
  ...
  {
    title: 'Marketing Agency Website Partnership Project',
    text:
  ...
  {
    title: 'Online Course Platform Design & Development',
    text:
  ...
  {
    title: 'Local Business Website Design Refresh',
    text:
  ...
  {
    title: 'Enterprise-Level Custom Web Solution',
    text:
...
const splitIntoThreeRows = (arr) => {
  const third = Math.ceil(arr.length / 2);
  return [
    arr.slice(0, third),
...
const Testimonials = () => {
  const [row01, row02] = splitIntoThreeRows(testimonials);
    ...
    <div id="newtestimonailsection">
      ...
      <style jsx>{`
        ...
        .marquee-track {
          ...
          gap: 18px;
          width: max-content;
          animation: 180s linear infinite;
