...
const Projects = () => {
  ...
  return (
    <>
      <main
        className="w-full flex-col-reverse justify-between md:flex md:flex-row lg:flex ct-container"
        id="project-tabs-wrapper"
        style={{
      ...
      >
        {/* project section left box  */}
        <div className="mx-auto items-center justify-center rounded-md w-[30%] images-wrapper">
          {tabImage === 0 && (
            <Image src={"/high-res.png"} loading="eager" alt="mob1" width={1000} height={1000} />
          )}
          {tabImage === 1 && (
            <Image src={"/mob-app03.png"} loading="eager" alt="mob2" width={1000} height={1000} />
          )}
          {tabImage === 2 && (
            <Image src={"/mob-app02.png"} loading="eager" alt="mob3" width={1000} height={1000} />
          )}
        </div>

        {/* project section right box */}
        <div className="ct-projects relative flex-row justify-between w-[70%] text-wrapper">
          {/* tab box for project  */}
          <div className="w-[100%] md:w-[70%]">
            {/* top heading */}
