...
const HeroSection = () => {
  ...
  return (
    <>
      <main
        className="relative m-auto w-full py-[0px] md:pt-[60px] lg:w-full"
      ...
      >
        <div className="relative flex w-[100%] flex-row justify-between overflow-hidden">
          {/* my header component  */}
          {/* <Header /> */}
          {/* <SEORankingWidget/> */}
          <Navbar />

          <div className="ct-container" id="hearosection">
          ...
          <div className="hidden w-[50%] overflow-y-hidden md:h-[100%] lg:block home-hero-slider">
            <HeroRightContent />
          </div>
